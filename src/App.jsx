                ...
                <div className="bg-white p-4 rounded-xl border-2 border-pink-200 mb-3">
                    ...
                    <button
                        onClick={() => {
                            ...
                            const link = `https://app.la-vie-beauty.com.br/?salonId=${encodeURIComponent(salonId)}`;
                            
                            // Mensagem otimizada para WhatsApp
                            const salonName = salonData?.name || 'nosso salão';
                            const message = `💅 Olá! Agende seu horário em ${salonName} através deste link:\n\n${link}\n\n✨ Agende com facilidade e rapidez!`;
                            
                            // Deep Link do WhatsApp (funciona em mobile e desktop)
                            // Formato: https://wa.me/?text=MENSAGEM_ENCODED
                            // Alternativa: https://api.whatsapp.com/send?text=MENSAGEM_ENCODED
                            ...
                            try {
                                ...
                                // Fallback: copia a mensagem e abre WhatsApp manualmente
                                navigator.clipboard.writeText(message).then(() => {
                                    alert("✅ Mensagem copiada! Cole no WhatsApp e envie para suas clientes.");
                                    window.open('https://web.whatsapp.com', '_blank');
                                }).catch(() => {
                                    // Último fallback: mostra a mensagem
                                    alert(`Copie esta mensagem e envie pelo WhatsApp:\n\n${message}`);
                                });
                            }
                        }}
